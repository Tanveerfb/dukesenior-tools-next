      ...
      {ready ? (
        <>
          ...
          <Table striped hover responsive>
            <thead><tr><th>Player Name</th><th>Cursed Item</th><th>Time</th><th>Run ID</th><th>Details</th></tr></thead>
            <tbody>
              {pageData.map(r=>{
                let variant = '';
                ...
                return (
                  <tr key={r[1]}>
                    ...
                    <td>{r[1] && <Link className="text-warning" href={`/phasmotourney-series/phasmotourney4/runs/${r[1]}`}>Details</Link>}</td>
                  </tr>
                );
              })}
            </tbody>
