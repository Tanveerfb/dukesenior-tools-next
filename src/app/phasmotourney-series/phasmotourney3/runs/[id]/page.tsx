    ...
    >
      {loading && (
        <div className="text-center my-5">
          <Spinner animation="border" /> Loading run…
        </div>
      )}
      {!loading && data && (
        <Table hover responsive>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{data.GhostPictureTaken ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Bone Picture [+2]</td>
              <td>{data.BonePictureTaken ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Objective 1 [+2]</td>
              <td>{data.Objective1 ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Objective 2 [+2]</td>
              <td>{data.Objective2 ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Objective 3 [+2]</td>
              <td>{data.Objective3 ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Survived [+5/+2/-5]</td>
              <td>{String(data.Survived)}</td>
            </tr>
            <tr>
              <td>Correct Ghost type? [+5]</td>
              <td>{data.CorrectGhostType ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Perfect game? [+2]</td>
              <td>{data.PerfectGame ? "true" : "false"}</td>
            </tr>
            <tr>
              <td>Time Criteria? [+2/+1/0]</td>
              <td>{data.Time}</td>
            </tr>
            <tr>
